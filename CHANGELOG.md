...
- **Schulungen**: Bugfix - "Kein verfügbares Personal gefunden" erschien bei Dekon-P immer, egal
  wie viel freies Personal ohne jede Ausbildung an der Wache stand. Ursache: Dekon-P heißt im
  Fahrzeug-Katalog und im Schul-Formular "dekon_p", auf der Personal-Auswahl-Seite des Spiels
  selbst aber "decontamination_personnel" - dadurch wurde bei Dekon-P schlicht niemand gefunden.
  Betrifft auch die angezeigte Anzahl fehlenden Personals bei Personal-Check/Schulungen/
  Wachenbauplan, die dadurch für Dekon-P künstlich zu hoch war.
